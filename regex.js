...
/*
    ...
    \S → 空白文字以外の全ての文字
    \d → 数字、[0-9]と同義
    \D → 数字以外の全ての文字、[^0-9]と同義
    \w → 全てのアルファベットとアンダースコアのうち1文字、[A-Za-z0-9_]と同義
    \W → 全てのアルファベットとアンダースコア以外の文字、[^A-Za-z0-9_]と同義
    \l → 全ての半角英小文字のうち1文字、[a-z]と同義
    \L → 全ての半角英小文字以外の文字、[^a-z]と同義
    \u → 全ての半角英大文字のうち1文字、[A-Z]と同義
    \U → 全ての半角英大文字以外の文字、[^A-Z]と同義
*/